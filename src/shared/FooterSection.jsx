...
const FooterSection = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-400 text-primary-content dark:bg-gray-800 dark:text-gray-100">
            <div>
               <img src="https://i.ibb.co/cDCjqcy/online-classes-icon-vector-23983367.jpg" alt=""  className='w-20 rounded-full'/>
