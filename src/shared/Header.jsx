    ...
    return (
        <div className="navbar bg-base-100 px-12 py-8 dark:bg-gray-800 dark:text-gray-100 ">
            <div className="navbar-start">
                ...
                <div className='flex'>
                    <img src="https://i.ibb.co/cDCjqcy/online-classes-icon-vector-23983367.jpg" alt="" className='w-9' />
                    <Link to="/home" className="btn btn-ghost normal-case text-xl">Online Education </Link>
                    <ul>
                        {
                            darkModeOn ?
